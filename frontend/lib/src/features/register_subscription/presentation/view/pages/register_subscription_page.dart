...
import 'package:frontend/src/features/register_subscription/presentation/viewmodel/register_subscription_viewmodel.dart';
...
class RegisterSubscriptionPage extends StatefulWidget {
  const RegisterSubscriptionPage({ Key? key }) : super(key: key);

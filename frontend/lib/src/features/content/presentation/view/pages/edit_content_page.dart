...
import '../../viewmodel/edit_content_viewmodel.dart';

class EditContentPage extends StatefulWidget {
  final Content content;
  const EditContentPage({Key? key, required this.content}) : super(key: key);

  @override
  State<EditContentPage> createState() => _EditContentPageState();
}

class _EditContentPageState extends ModularState<EditContentPage, EditContentViewModel> { //Alterar Subscription
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: (content != null) ?
            Text('content_edition_success'.i18n(),
              style: const TextStyle(
                fontFamily: 'Nunito',
                fontSize: 18,
                fontWeight: FontWeight.bold,
            ...
            Text('content_edition_error'.i18n(),
              style: const TextStyle(
                fontFamily: 'Nunito',
                fontSize: 18,
              ),
          ...
          <Widget>[ TextButton(
              ...
              onPressed: () {
                Navigator.pop(context);
                Modular.to.pushNamed('detailcontent', arguments: widget.content);
              },  
            ),
            TextButton(
              child: Text('ok'.i18n().toString()),
